...
parser.add_argument('--cfg', type=str, default='./output/07051216/train_v107_pl.yaml')
parser.add_argument('--diff_cfg', type=str, default='./output/07051216/train_v107.yaml', help='diff config file. like: two_spec_022401.yaml')
